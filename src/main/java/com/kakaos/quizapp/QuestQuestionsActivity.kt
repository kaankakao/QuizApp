...
class QuestQuestionsActivity : AppCompatActivity(), OnClickListener {
    ...
    private var tvOptionFive: TextView? = null
    private var btnSubmit: Button? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_quest_questions)
    ...
    private fun selectedOptionView(tv: TextView, selectedOptionNum: Int) {
        ...
        tv.background = ContextCompat.getDrawable(this, R.drawable.selected_option_borger_bg)
    }
